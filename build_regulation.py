...
<div class="wrap">
  <div class="deskbar">
    <span class="db-title">REGULATORY RADAR</span>
    <span class="db-sub">ΕΑΔ + ΥΠΕΣ · Διαύγεια</span>
    <div class="db-filters">
      ...
      <div class="seg">
        ...
        <button data-win="365" aria-pressed="false">1έτος</button>
        <button data-win="0" aria-pressed="true">Όλα</button>
      </div>
    </div>
    <div class="db-stats">
      <span><b id="s-all">0</b> items</span>
      <span><b id="s-90">0</b> /90ημ</span>
