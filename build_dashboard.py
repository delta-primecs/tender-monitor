...
<div class="wrap">
  <div class="deskbar">
    <span class="db-title">TENDER RADAR</span>
    <span class="db-sub">ΚΗΜΔΗΣ + ΕΣΗΔΗΣ · open</span>
    <div class="db-filters">
      <div class="seg" id="seg-cat" role="group" aria-label="Category"></div>
      <div class="seg">
        <button data-proc="all" aria-pressed="true">Όλα</button>
        <button data-proc="competition" aria-pressed="false">Διαγων.</button>
        <button data-proc="direct" aria-pressed="false">Απευθ.</button>
      </div>
      <div class="seg">
      ...
      <div class="seg">
        <button data-sort="deadline" aria-pressed="true">Λήξη</button>
        <button data-sort="value" aria-pressed="false">Αξία</button>
      </div>
    </div>
    <div class="db-stats">
      <span><b id="stat-shown">0</b> εμφαν.</span>
      <span><b class="hot" id="stat-closing">0</b> ≤3ημ</span>
